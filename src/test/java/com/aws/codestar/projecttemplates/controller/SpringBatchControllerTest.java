...
/**
 * Tests for {@link SpringBatchController}. Modify the tests in order to support your use case as you build your project.
 */
@DisplayName("Tests for HelloWorldController")
class SpringBatchControllerTest {
    ...
    private final SpringBatchController controller = new SpringBatchController();
    ...
    /**
     * Basic test to verify the result obtained when calling {@link SpringBatchController#helloWorldGet} successfully.
     */
    @Test
